...
const NAV_ITEMS: NavItem[] = [
  ...
  { label: 'Compliance Checks', icon: '✓', route: '/compliance-checks', roles: ['Safety Officer', 'Administrator', 'Compliance Officer', 'Government Auditor'] },
  { label: 'Programs', icon: '📋', route: '/programs', roles: ['Manager', 'Administrator', 'Government Auditor'] },
  { label: 'My Training', icon: '🎓', route: '/trainings', roles: ['Employee'] },
  { label: 'Trainings', icon: '🎓', route: '/trainings', roles: ['Manager', 'Administrator', 'Safety Officer'] },
